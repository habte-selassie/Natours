...
Natours is a highly functional tour booking website developed on NodeJS, which offers a wide array of features. These include authentication and authorization, providing users with the ability to log in and out of their accounts, and allowing them to search for tours, book them, manage their bookings, and also update their profiles. It also provides API endpoints for accessing information about tours such as  tour stats, top 5 cheap tours, and tours within a radius.
Furthermore, it provides a secure, user-friendly credit card payment to facilitate seamless and safe transactions.
...
| Tour Management & Modeling       | includes managing tour bookings, rendering tour maps, and displaying user reviews and ratings on each tour. |
...
## Demonstration
Natours provides a highly interactive and user-friendly interface for booking tours. Some of the major highlights of Natours are:
...
1. Sign up or Login to the site with the following email and password.
  ...
  - Password: test1234
  ```
2. Search for the tours you want.
...
- Render ability for the user to write comments
